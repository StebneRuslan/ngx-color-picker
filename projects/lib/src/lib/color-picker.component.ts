...
export class ColorPickerComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  public cpFavouriteLabel: string;
  public cpFavouriteColors: string[];
  public cpFavouriteColorsClass: string;
  public cpMaxFavouriteColorsLength: number;
  
  public cpFavouriteEmptyMessage: string;
  public cpFavouriteEmptyMessageClass: string;
  
  public cpAddColorButton: boolean;
  public cpFavouriteColorButton: boolean;
  public cpDeleteFavouriteColorButton: boolean;
  ...
  public setupDialog(instance: any, elementRef: ElementRef, color: any,
                     ...
                     cpFavouriteLabel: string, cpFavouriteColors: string[], cpFavouriteColorsClass: string,
                     cpMaxFavouriteColorsLength: number, cpFavouriteEmptyMessage: string,
                     cpFavouriteEmptyMessageClass: string,
  
                     cpOKButton: boolean, cpOKButtonClass: string,
                     cpOKButtonText: string, cpCancelButton: boolean, cpCancelButtonClass: string,
                     cpCancelButtonText: string, cpAddColorButton: boolean, cpFavouriteColorButton: boolean, cpAddColorButtonClass: string,
                     cpAddColorButtonText: string, cpRemoveColorButtonClass: string): void
  {
    ...
    this.setFavouriteConfig(cpFavouriteLabel, cpFavouriteColors);
    ...
    this.cpFavouriteColorsClass = cpFavouriteColorsClass;
    this.cpMaxFavouriteColorsLength = cpMaxFavouriteColorsLength;
    this.cpFavouriteEmptyMessage = cpFavouriteEmptyMessage;
    this.cpFavouriteEmptyMessageClass = cpFavouriteEmptyMessageClass;
    
    this.cpAddColorButton = cpAddColorButton;
    this.cpFavouriteColorButton = cpFavouriteColorButton;
  ...
  public setFavouriteConfig(cpFavouriteLabel: string, cpFavouriteColors: string[]): void {
    this.cpFavouriteLabel = cpFavouriteLabel;
    this.cpFavouriteColors = cpFavouriteColors || [];
  }
