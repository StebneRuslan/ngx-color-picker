...
export class ColorPickerDirective implements OnChanges, OnDestroy {
  ...
  @Input() cpFavouriteEmptyMessageClass: string = 'preset-empty-message';
  
  @Input() cpAddColorButton: boolean = false;
  @Input() cpFavouriteColorButton: boolean = false;
  ...
  @Output() cpFavouriteColorsChange = new EventEmitter<any>(true);
  
  @Output() cpFavouriteColorsAdded = new EventEmitter<any>(true);
  @Output() cpFavouriteColorsRemoved = new EventEmitter<any>(true);
  ...
  ngOnChanges(changes: any): void {
    ...
    if (changes.cpFavouriteLabel || changes.cpFavouriteColors) {
      if (this.dialog) {
        this.dialog.setFavouriteConfig(this.cpFavouriteLabel, this.cpFavouriteColors);
      }
    }
  }
  ...
  public openDialog(): void {
    if (!this.dialogCreated) {
      ...
      this.cmpRef.instance.setupDialog(this, this.elRef, this.colorPicker,
        ...
        this.cpPresetLabel, this.cpPresetColors,
        this.cpPresetColorsClass, this.cpMaxPresetColorsLength, this.cpPresetEmptyMessage,
        this.cpPresetEmptyMessageClass,
        
        this.cpFavouriteLabel, this.cpFavouriteColors,
        this.cpFavouriteColorsClass, this.cpMaxFavouriteColorsLength, this.cpFavouriteEmptyMessage,
        this.cpFavouriteEmptyMessageClass,
        
        this.cpOKButton, this.cpOKButtonClass,
        this.cpOKButtonText, this.cpCancelButton, this.cpCancelButtonClass,
        this.cpCancelButtonText, this.cpAddColorButton, this.cpFavouriteColorButton, this.cpAddColorButtonClass,
  ...
  public favouriteColorsChanged(value: any[]): void {
    this.cpFavouriteColorsChange.emit(value);
  }
}
